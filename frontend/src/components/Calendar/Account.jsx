...
const Account = ({ account, content, amount, categoryName, setValue, categoryId, Id }) => {
  ...
  return (
    <>
      ...
      {modalOpen && (
        ...
        {account === '지출' ? <LedgerChange Id={Id} defaultCategoryId={categoryId} value={setValue} defaultContent={content} defaultamount={amount}/> : <LedgerChange isIncome={1} Id={Id} defaultCategoryId={categoryId} value={setValue} defaultContent={content} defaultamount={amount}/>}
      </Modal>
      )}
    </>
  );
