                ...
                <InputContainer>
                    ...
                    {isHourly ? (
                        <>
                            ...
                            <div>
                                <Input type="time" value={myWkStart} onChange={handleMyWkStartChange} />
                                <p className="label"> - </p>
                                <Input type="time" value={myWkEnd} onChange={handleMyWkEndChange} />
                            </div>
                            <div>
                                <p className="label">휴게시간</p>
                                <Input type="number" min="0" value={myWkRest} onChange={handleMyWkRestChange} />
                    ...
                    <div>
                        ...
                        <Input type="date" value={myWkPayday} onChange={handleMyWkPaydayChange} />
                    </div>
