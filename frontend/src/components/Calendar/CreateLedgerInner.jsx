...
const CreateScheduleInner = ({ isIncome, value }) => {
    ...
    const onCreateExpense = async () => {
        try {
            ...
            const createExpense = await LedgerAxiosAPI.createExpense(categoryId, parsedAmount, date, content);
    ...
    const onCreateIncome = async () => {
        try {
            const parsedAmount = parseInt(amount);
            const createIncome = await LedgerAxiosAPI.createIncome(categoryIncomeId, parsedAmount, date, content);
