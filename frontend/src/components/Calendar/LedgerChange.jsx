...
const LedgerChange = ({ isIncome, defaultCategoryId, value, defaultContent, defaultamount, Id }) => {
    ...
    const onChangeExpense = async () => {
        try {
            ...
            const changeExpense = await LedgerAxiosAPI.changeExpense(categoryId, parsedAmount, date, content, Id);
    ...
    const onChangeIncome = async () => {
        try {
            const parsedAmount = parseInt(amount);
            const changeIncome = await LedgerAxiosAPI.changeIncome(categoryIncomeId, parsedAmount, date, content, Id);
            ...
            <CreateScheduleContainer>
                ...
                <Container>
                    ...
                    <InputContainer>
                        ...
                        <Input type="date" id="date" defaultValue={date} onChange={handleDateChange} />
