            ...
            <Wrapper>
                <div>
                    ...
                    <p className="ls2" lh6 bs5 ts4>
                        <em className="emphasis">&lt; MoneyPlant &gt;('https://moneyplan.today/'이하 'MoneyPlant')</em>
                        은(는) 「개인정보 보호z법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을
                        신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
                    </p>
                    <p className="ls2">
                        ○ 이 개인정보처리방침은 <em className="emphasis">2023</em>년 <em className="emphasis">7</em>월{' '}
                        <em className="emphasis">25</em>부터 적용됩니다.
                    </p>
                    <br />
                    <p className="lh6 bs4">
                        <strong>
                    ...
                    <ul className="list_indent2 mgt10">
                        ...
                        <p className="ls2">
                            회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 서비스 부정이용 방지 목적으로
                            개인정보를 처리합니다.
                        </p>
                        <br />
                        ...
                        <p className="ls2">
                            신규 서비스(제품) 개발 및 맞춤 서비스 제공, 서비스의 유효성 확인 등을 목적으로 개인정보를
                            처리합니다.
                        </p>
                        <br />
                    </ul>
                    ...
                    <p className="lh6 bs4">
                        ...
                        <br />
                        <br />① <em className="emphasis">&lt; MoneyPlant &gt;</em>은(는) 법령에 따른 개인정보
                    ...
                    <p className="lh6 bs4">
                        ...
                        <br />
                        <br /> ① <em className="emphasis">&lt; MoneyPlant &gt;</em>은(는) 다음의 개인정보 항목을
                        처리하고 있습니다.
                    </p>
                    <ul className="list_indent2 mgt10">
                        <li className="tt">1&lt; 홈페이지 회원가입 및 관리 &gt;</li>
                    ...
                    <p className="lh6 bs4">
                        ...
                        <br /> ①{' '}
                        <em className="emphasis">
                            &lt; MoneyPlant &gt;은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만
                    ...
                    <p className="sub_p mgt10">
                        <em className="emphasis">
                            ② <span className="colorLightBlue">&lt; MoneyPlant &gt;</span>은(는) 다음과 같이 개인정보를
                            제3자에게 제공하고 있습니다.
                        </em>
                    </p>
                    <ul className="list_indent2 mgt10">
                        ...
                        <li>
                            <em className="emphasis">제공받는 자의 개인정보 이용목적 : 서비스 이용 기록</em>
                        </li>
                        <li>
                    ...
                    <em className="emphasis">
                        ...
                        <p className="lh6 bs4">
                            ...
                            <br />
                            <br /> ① <em className="emphasis">&lt; MoneyPlant &gt;</em>은(는) 원활한 개인정보 업무처리를
                        ...
                        <p className="sub_p mgt10">
                            ② <span className="colorLightBlue">&lt; MoneyPlant &gt;</span>은(는) 위탁계약 체결시
                        ...
                        <p className="ls2">
                            <em className="emphasis">
                                <br />① &lt; MoneyPlant &gt; 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
                                ...
                                <br />
                                1. 파기절차
                                <br /> &lt; MoneyPlant &gt; 은(는) 파기 사유가 발생한 개인정보를 선정하고, &lt;
                                MoneyPlant &gt; 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
                                <br />
                            </em>
                        </p>
                        <p className="sub_p mgt10">
                        ...
                        <em className="emphasis">
                            ...
                            <p className="ls2">
                                <br />
                                <br />① 정보주체는 MoneyPlant에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의
                                권리를 행사할 수 있습니다.
                            </p>
                            <p className="sub_p">
                                ② 제1항에 따른 권리 행사는MoneyPlant에 대해 「개인정보 보호법」 시행령 제41조제1항에
                                따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 MoneyPlant은(는) 이에 대해
                                지체 없이 조치하겠습니다.
                            </p>
                            <p className="sub_p">
                            ...
                            <p className="sub_p">
                                ⑥ MoneyPlant은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구
                            ...
                            <p className="sub_p mgt10">
                                ...
                                <em className="emphasis">MoneyPlant</em>')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보
                                유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터
                            ...
                            <p className="ls2">
                                <br />
                                <br />① MoneyPlant 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를
                            ...
                            <p className="lh6 bs4">
                                ...
                                <em className="emphasis">
                                    <br />
                                    <br />
                                    &lt; MoneyPlant &gt; 은(는) ｢개인정보 보호법｣ 제15조제3항 및 제17조제4항에 따라
                                    ｢개인정보 보호법 시행령｣ 제14조의2에 따른 사항을 고려하여 정보주체의 동의 없이
                                    개인정보를 추가적으로 이용·제공할 수 있습니다. 이에 따라 &lt; MoneyPlant &gt; 가(이)
                                    정보주체의 동의 없이 추가적인 이용·제공을 하기 위해서 다음과 같은 사항을
                                    고려하였습니다.
                                    <br />▶ 개인정보를 추가적으로 이용·제공하려는 목적이 당초 수집 목적과 관련성이
                                    있는지 여부
                                </em>
                            </p>
                            <p className="sub_p" />
                            ...
                            <em className="emphasis">
                                ...
                                <br />
                                <p className="lh6 bs4">
                                    <strong>제12조(가명정보를 처리하는 경우 가명정보 처리에 관한 사항)</strong>
                                    <em className="emphasis">
                                        <br />
                                        <br />
                                        &lt; MoneyPlant &gt; 은(는) 다음과 같은 목적으로 가명정보를 처리하고 있습니다.
                                    </em>
                                </p>
                                <p className="sub_p" />
                                <p className="sub_p">
                                ...
                                <p className="sub_p mgt10">
                                    <em className="emphasis">
                                        {' '}
                                        ① <span className="colorLightBlue">MoneyPlant</span> 은(는) 개인정보 처리에 관한
                                ...
                                <ul className="list_indent2 mgt10">
                                    ...
                                    <li>
                                        <em className="emphasis">연락처 :01024477508, wlrudnjtkddn@naver.com, </em>
                                    </li>
                                </ul>
                                <p className="sub_p">
                                ...
                                <p className="sub_p">
                                    <em className="emphasis">
                                        ② 정보주체께서는 MoneyPlant 의 서비스(또는 사업)을 이용하시면서 발생한 모든
                                        개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자
                                        및 담당부서로 문의하실 수 있습니다. MoneyPlant 은(는) 정보주체의 문의에 대해
                                ...
                                <p className="sub_p mgt30">
                                    <em className="emphasis">
                                        <strong>
                                            ...
                                            아래의 부서에 할 수 있습니다.
                                            <br />
                                            &lt; MoneyPlant &gt;은(는) 정보주체의 개인정보 열람청구가 신속하게
                                            처리되도록 노력하겠습니다.{' '}
                                        </strong>
                                    </em>
                                </p>
                                ...
                                <em className="emphasis">
                                    ...
                                    <br />
                                    <p />
                                    <p className="sub_p">① 이 개인정보처리방침은 2023년 7월 25부터 적용됩니다.</p>
                                    <p className="sub_p" />
                                    <p className="sub_p" />
                                    <p className="sub_p">
